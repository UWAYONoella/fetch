...
// //   log.insertAdjacentHTML('beforeend',`${thisCount})Started<br>`);
  
// //   const p=new Promise((resolve,reject)=>{
// // log.insertAdjacentHTML('beforeend',
// // `${thisCount})promise constructor <br>`);
// //  setTimeout(()=>{
// //   resolve(thisCount);
// //  },3000);
// //   });
...
// // });
// // log.insertAdjacentHTML('beforeend',`${thisCount})promise made<br>`);
// // }
// // const but=document.getElementById("promise");
// // but.addEventListener("click",promise);
...
//   }
//   ];
//  const images=myArr.map((item)=>(`<img src=${item.avatar_url}>${item.id},${item.login}`));
// const photo= document.getElementById("photo");
// photo.innerHTML+=`${images}`;



const main=document.querySelector("body");
const photo=(src,name,id)=>{
   const card=
   `<div class="card">
...
<div class="card-name" style="color:green;">${name}</div>
<i style="color:white ;">"Our Equilibrium collection 
promotes balance and calm"
</i>
<div class="card-id" style="color:white;">${id}</div>
<span style="margin-top:-70px"><hr> </span>
<div class ="mage"><img src=${src}>
</div>
...
const fetchData=async()=>{
    ...
    data.map(item=>{
            photo(item.avatar_url,item.login,item.id)
         })
   }
   fetchData();
